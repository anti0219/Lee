...
public class Constants {
    ...
    public final static String FILE_UPLOAD_DIC = "/Users/johnnyzhang/Documents/upload/";//上传文件的默认url前缀，根据部署设置自行修改
	...
	public static final int INDEX_GOODS_RADOM_NUMBER = 5;//首页随机商品数量
	public static final int INDEX_GOODS_HISTORY_NUMBER= 10;//首页随机商品数量
