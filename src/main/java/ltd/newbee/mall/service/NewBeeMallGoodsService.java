...
public interface NewBeeMallGoodsService {
	...
	List<Long> getAnswerById(List<Long> answerId);
	...
	void recordUserBrowseHistory(Long userId, Long goodsId);//记录用户浏览历史
	
	SkuUpdateInfo getSkuInfoByUserSelect (int goodsId,List<List<?>> userSelectParams);
	
	//review model
	PageResult getReviewList(PageQueryUtil pageUtil);

	int insertComment(Review params);
