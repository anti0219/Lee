...
public class NewBeeMallOrderServiceImpl implements NewBeeMallOrderService {
    ...
    public PageResult getNewBeeMallOrdersPage(PageQueryUtil pageUtil) {
        List<NewBeeMallOrder> newBeeMallOrders = newBeeMallOrderMapper.findNewBeeMallOrderList(pageUtil);//返回数据库里分页范围内的数据放入list
        int total = newBeeMallOrderMapper.getTotalTmpList(pageUtil);//获取一共有多少条的数据
