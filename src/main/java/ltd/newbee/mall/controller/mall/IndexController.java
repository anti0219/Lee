...
public class IndexController {
    ...
    public String indexPage(HttpServletRequest request) {
        ...
        List<NewBeeMallIndexConfigGoodsVO> randomGoodses = newBeeMallIndexConfigService.getConfigGoodsesForIndex(IndexConfigTypeEnum.INDEX_GOODS_RANDOM.getType(), Constants.INDEX_GOODS_RADOM_NUMBER);

        List<NewBeeMallIndexConfigGoodsVO> historyGoodses = newBeeMallIndexConfigService.getHistoryGoodsesForIndex(IndexConfigTypeEnum.INDEX_GOODS_HISTORY.getType(), Constants.INDEX_GOODS_HISTORY_NUMBER);
        ...
        request.setAttribute("randomGoodses", randomGoodses);
        request.setAttribute("historyGoodses", historyGoodses);//浏览历史
        return "mall/index";//用于解析对应的html文件
    }
}
